...
import java.sql.*;
public class JDBCPreparedStatement  implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) 
	{
        ...
        */
     	...
     	//	Statement st = con.createStatement();
     		...
     		stmt.setInt(1, Integer.parseInt(txtEmpcode.getText()));
     		stmt.setString(2, txtEmpname.getText());
     		stmt.setString(3, txtDesignation.getText());
     		stmt.setInt(4, Integer.parseInt(txtDno.getText()));
